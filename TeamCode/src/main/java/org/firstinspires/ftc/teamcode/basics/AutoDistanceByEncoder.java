...
@Autonomous(name=" Georgii Auto Distance By Encoder", group="Robot")
public class AutoDistanceByEncoder extends LinearOpMode {
   ...
   static final double PULSES_PER_CM = PULSES/(Math.PI*WHEEL_DIAMETR*3);
   ...
   public void runOpMode() {
       ...
       while (opModeIsActive()&&leftBack.getCurrentPosition()<60*PULSES_PER_CM){
       ...
       while (opModeIsActive()&&leftBack.getCurrentPosition()>-120*PULSES_PER_CM){
           telemetry.addData("назад",leftFront.getCurrentPosition());
           telemetry.addData("назад",rightFront.getCurrentPosition());
           telemetry.addData("назад",leftBack.getCurrentPosition());
           telemetry.addData("назад",rightBack.getCurrentPosition());
           telemetry.update();
       }
