...
@Autonomous(name="Ksusha: Auto Distance By Encodor", group="Robot")
public class AutoDistanceByEncoder_Ksusha extends LinearOpMode {
   ...
   public void runOpMode() {
       ...
       while (opModeIsActive() && leftBack.getCurrentPosition() >120*-PULSES_PER_CM){
           telemetry.addData("тики назад", leftBack.getCurrentPosition());
           telemetry.addData("тики назад", leftFront.getCurrentPosition());
           telemetry.addData("тики назад", rightBack.getCurrentPosition());
           telemetry.addData("тики назад", rightFront.getCurrentPosition());
