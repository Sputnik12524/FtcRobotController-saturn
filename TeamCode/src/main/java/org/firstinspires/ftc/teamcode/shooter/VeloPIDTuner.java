...
public class VeloPIDTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        // Change my id
        myMotor = hardwareMap.get(DcMotorEx.class, "shooter");
        ...
        setPIDFCoefficients(myMotor, MOTOR_PID);
        ...
        while (!isStopRequested() && opModeIsActive()) {
            ...
            if (lastKp != MOTOR_PID.p || lastKi != MOTOR_PID.i || lastKd != MOTOR_PID.d || lastKf != MOTOR_PID.f) {
                setPIDFCoefficients(myMotor, MOTOR_PID);
